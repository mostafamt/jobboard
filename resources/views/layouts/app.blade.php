...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/css/bootstrap-select.min.css') }}">
                ...
                <div class="row align-items-center">
                    ...
                    <nav class="mx-auto site-navigation">
                        <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
                            <li><a href="index.html" class="nav-link active">Home</a>
                            </li>
                            ...
                            <li class="d-lg-none"><a href="post-job.html"><span
                                        class="mr-2">+</span> Post a Job</a>
                            </li>
                            <li class="d-lg-none"><a href="login.html">Log
                                    In</a></li>
                        </ul>
                    </nav>
                    ...
                    <div
                        ...
                        <div class="ml-auto">
                            ...
                            <a href="login.html"
                                class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span
                                    class="mr-2 icon-lock_outline"></span>Log
                                In</a>
                        </div>
                        <a href="#"
